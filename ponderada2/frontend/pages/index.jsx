...
export default function AuthPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Lógica para redirecionar o usuário após o login ou cadastro
      // Exemplo: redirecionar para a página inicial
      if (isSignup) window.location.href = '/'; // Substitua pela URL desejada
      else
      window.location.href = '/Note'; // Substitua pela URL desejada
    } catch (error) {
